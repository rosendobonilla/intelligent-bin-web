...
import {getTrashHistory} from "../../redux/actions/dataActions";


class Tables extends React.Component {

  componentDidMount() {
    this.props.getTrashHistory();
  }
            ...
            <div className="col">
              <Card className="bg-default shadow">
                <CardHeader className="bg-transparent border-0">
                  <h3 className="text-white mb-0">Mi basura en el tiempo</h3>
                </CardHeader>
                <Table
                ...
                >
                  ...
                  {this.props.trash && this.props.trash.trashHistory &&
                  // and lastly, we render them using the map function
                  this.props.trash.trashHistory.map((prop, key) => {
                    return (
                    <tr key={key}>
                      <th scope="row">
                        <Media className="align-items-center">
                      ...
                      <td>
                        <Badge color="" className="badge-dot mr-4">
                          <i className="bg-warning" />
                          {dayjs(prop.createdAt).format('h:mm a, DD MMMM YYYY')}
                          {" "}<span className="text-success">{dayjs(prop.createdAt).fromNow()}</span>
                        </Badge>
                      </td>
                    </tr>
                    );
...
export default connect(mapStateToProps, {getTrashHistory})(Tables);
